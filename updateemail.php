...
$result = mysqli_query($link, $sql);
if(!$result){
    echo "<div class='alert alert-danger'><strong>There was error in inserting the user details in table.</strong></div>";
}
else{
    ...
    $message .= "http://localhost/saurabh/HTML/NotePad/activatenewemail.php?email=".urlencode($email). "&newemail=".urlencode($newemail). "&key=$activationKey";
